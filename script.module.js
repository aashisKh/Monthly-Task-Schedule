...
import { fetchTimelyTask } from "./scripts/notification.mjs";
...
let updateTaskStatusSection = document.getElementById(
...
const updateTask = async () => {
  ...
  if (previousSelectedTaskStatusIndex) {
    ele.children[previousSelectedTaskStatusIndex].classList.remove(
...
const checkTaskTime = setInterval(() => {
  let date = new Date()
  let minutes = date.getMinutes()
  if(minutes % 10 != 0){
    clearInterval(checkTaskDate)
